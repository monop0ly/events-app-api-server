 ...
 */cov_220x767nb0().s[3]++;router.get('/:id',async(req,res)=>{cov_220x767nb0().f[0]++;cov_220x767nb0().s[4]++;res.json(await db.getEventById(req.params.id));});/**
 * POST /api/event
 * Creates a new event from the data in the request body (req.body)
 * Returns the list of all events including the new event
 */cov_220x767nb0().s[5]++;router.post('/',async(req,res)=>{cov_220x767nb0().f[1]++;// add to the database
const events=(cov_220x767nb0().s[6]++,await db.addEvent(req.body));// return all events
cov_220x767nb0().s[7]++;res.status(201).json(events);});/**
 * PUT /api/event/:id
 ...
 */cov_220x767nb0().s[8]++;router.put('/:id',async(req,res)=>{cov_220x767nb0().f[2]++;const events=(cov_220x767nb0().s[9]++,await db.updateEvent(req.params.id,req.body));cov_220x767nb0().s[10]++;res.json(events);});/**
 * DELETE /api/event/:id
 ...
 */cov_220x767nb0().s[11]++;router.delete('/:id',async(req,res)=>{cov_220x767nb0().f[3]++;const events=(cov_220x767nb0().s[12]++,await db.deleteEvent(req.params.id));cov_220x767nb0().s[13]++;res.json(events);});cov_220x767nb0().s[14]++;module.exports=router;
